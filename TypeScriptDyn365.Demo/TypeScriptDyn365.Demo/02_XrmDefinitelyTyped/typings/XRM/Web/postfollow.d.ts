...
interface WebEntitiesRetrieve {
  postfollows: WebMappingRetrieve<Dyn365WebApi.PostFollow_Select,Dyn365WebApi.PostFollow_Expand,Dyn365WebApi.PostFollow_Filter,Dyn365WebApi.PostFollow_Fixed,Dyn365WebApi.PostFollow_Result,Dyn365WebApi.PostFollow_FormattedResult>;
}
interface WebEntitiesRelated {
  postfollows: WebMappingRelated<Dyn365WebApi.PostFollow_RelatedOne,Dyn365WebApi.PostFollow_RelatedMany>;
}
interface WebEntitiesCUD {
  postfollows: WebMappingCUD<Dyn365WebApi.PostFollow_Create,Dyn365WebApi.PostFollow_Update>;
}
