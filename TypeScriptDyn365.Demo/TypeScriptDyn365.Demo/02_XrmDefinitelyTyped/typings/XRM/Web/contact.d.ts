declare namespace Dyn365WebApi {
  ...
  interface Contact_Select {
    ...
    foo_age: WebAttribute<Contact_Select, { foo_age: number | null }, {  }>;
...
interface WebEntitiesRetrieve {
  contacts: WebMappingRetrieve<Dyn365WebApi.Contact_Select,Dyn365WebApi.Contact_Expand,Dyn365WebApi.Contact_Filter,Dyn365WebApi.Contact_Fixed,Dyn365WebApi.Contact_Result,Dyn365WebApi.Contact_FormattedResult>;
}
interface WebEntitiesRelated {
  contacts: WebMappingRelated<Dyn365WebApi.Contact_RelatedOne,Dyn365WebApi.Contact_RelatedMany>;
}
interface WebEntitiesCUD {
  contacts: WebMappingCUD<Dyn365WebApi.Contact_Create,Dyn365WebApi.Contact_Update>;
}
