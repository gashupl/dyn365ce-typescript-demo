declare namespace XrmQuery {
     ...
     */
    function create<ICreate>(entityPicker: (x: WebEntitiesCUD) => WebMappingCUD<ICreate, any>, record?: ICreate): XQW.CreateRecord<ICreate>;
    /**
     ...
     */
    function update<IUpdate>(entityPicker: (x: WebEntitiesCUD) => WebMappingCUD<any, IUpdate>, id?: string, record?: IUpdate): XQW.UpdateRecord<IUpdate>;
    /**
     ...
     * @param id GUID of the record to be updated.
     */
    function deleteRecord(entityPicker: (x: WebEntitiesCUD) => WebMappingCUD<any, any>, id?: string): XQW.DeleteRecord;
    /**
...
declare namespace XQW {
    ...
    class CreateRecord<ICreate> extends Query<string> {
        private record;
        constructor(entityPicker: (x: WebEntitiesCUD) => WebMappingCUD<ICreate, any>, record?: ICreate | undefined);
    ...
    class DeleteRecord extends Query<undefined> {
        private id;
        constructor(entityPicker: (x: WebEntitiesCUD) => WebMappingCUD<any, any>, id?: string | undefined);
    ...
    class UpdateRecord<IUpdate> extends Query<undefined> {
        private id;
        private record;
        constructor(entityPicker: (x: WebEntitiesCUD) => WebMappingCUD<any, IUpdate>, id?: string | undefined, record?: IUpdate | undefined);
        protected handleResponse(req: XMLHttpRequest, successCallback: (x?: undefined) => any): void;
