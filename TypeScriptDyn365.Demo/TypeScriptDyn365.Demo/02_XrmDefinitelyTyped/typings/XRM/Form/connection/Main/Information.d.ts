declare namespace Form.connection.Main {
  namespace Information {
    ...
    interface Attributes extends Xrm.AttributeCollectionBase {
      ...
      get(name: "record1roleid"): Xrm.LookupAttribute;
      get(name: "record2id"): Xrm.Attribute<any>;
      get(name: "record2roleid"): Xrm.LookupAttribute;
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      ...
      get(name: "record1roleid"): Xrm.LookupControl;
      get(name: "record2id"): Xrm.Control<Xrm.Attribute<any>>;
      get(name: "record2roleid"): Xrm.LookupControl;
      get(name: string): undefined;
      get(): Xrm.BaseControl[];
  ...
  interface Information extends Xrm.PageBase<Information.Attributes,Information.Tabs,Information.Controls> {
    ...
    getAttribute(attributeName: "record1roleid"): Xrm.LookupAttribute;
    getAttribute(attributeName: "record2id"): Xrm.Attribute<any>;
    getAttribute(attributeName: "record2roleid"): Xrm.LookupAttribute;
    ...
    getControl(controlName: "record1roleid"): Xrm.LookupControl;
    getControl(controlName: "record2id"): Xrm.Control<Xrm.Attribute<any>>;
    getControl(controlName: "record2roleid"): Xrm.LookupControl;
