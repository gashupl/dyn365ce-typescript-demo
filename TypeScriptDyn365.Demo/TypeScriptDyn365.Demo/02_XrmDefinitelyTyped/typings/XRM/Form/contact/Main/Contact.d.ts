declare namespace Form.contact.Main {
  namespace Contact {
    ...
    interface Attributes extends Xrm.AttributeCollectionBase {
      ...
      get(name: "foo_age"): Xrm.NumberAttribute;
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      ...
      get(name: "foo_age"): Xrm.NumberControl;
  ...
  interface Contact extends Xrm.PageBase<Contact.Attributes,Contact.Tabs,Contact.Controls> {
    ...
    getAttribute(attributeName: "foo_age"): Xrm.NumberAttribute;
    ...
    getControl(controlName: "foo_age"): Xrm.NumberControl;
